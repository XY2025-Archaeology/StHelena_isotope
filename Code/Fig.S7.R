...
####################This script is for creating figure S7#######################
...
df<-read_excel("data/FigS7_Data.xlsx")
colnames(df)[9]<-"Sriso"
...
FigS7<-ggarrange(p1,p3,p5,ncol=3,common.legend = F)
 
# Save figure as high-resolution PDF
ggsave("figures/FigS7.pdf", FigS7,width = 18, height = 8,units="cm")


## We used Adobe Illustrator to further refine the figures, particularly by revising the color scheme to improve accessibility for readers with color vision deficiency